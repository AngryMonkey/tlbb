...
function x002956_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	if nNumText == 100 then
		BeginEvent(sceneId)
			...
			if nNumText == 100 then
			AddNumText(sceneId, x002956_g_ScriptId, "#gFF6A6A#G激活#Y凤歌鸾舞一级", 1, nNumText+10)
...
--			AddNumText(sceneId, x002956_g_ScriptId, "#gFF6A6A#G激活#Y游云惊龙一级", 1, nNumText+90)
...
--			AddNumText(sceneId, x002956_g_ScriptId, "#gFF6A6A#G激活#I【玄】游云惊龙", 1, nNumText+160)
	...
	if nNumText > 100 and nNumText < 800  then
		BeginEvent(sceneId)
			...
			local szStr = "  要获得这些装备，你需要给我#gfff0f0“" .. x002956_g_StoneList[nLevel].str
										.. "”#cFFCC00“".. tostring(x002956_g_StoneList[nLevel].num) .. "”#W个  #r#cFFCC00得其者得天下，武林中人梦寐以求的神器！#W"
