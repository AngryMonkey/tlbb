...
function x300053_ChuanSong(sceneId,selfId,key,isNPC)
	...
	if key==400 then
		BeginEvent(sceneId)
			...
			AddNumText(sceneId, x300053_g_scriptId,"#cff0000BOSS区域     #R【快速获取宝物】", 9, 404)
	...
	elseif key==401 then
		BeginEvent(sceneId)
			...
			AddNumText(sceneId, x300053_g_scriptId,"#cff0000楼兰古城     #R【楼兰古城】", 9, 424)
			AddNumText(sceneId, x300053_g_scriptId,"#c00ffff繁华大理     #R【繁华大理】", 9, 421)
			AddNumText(sceneId, x300053_g_scriptId,"#c00ffff古城洛阳     #R【古城洛阳】", 9, 422)
			AddNumText(sceneId, x300053_g_scriptId,"#c00ffff江南苏州     #R【江南苏州】", 9, 423)
			AddNumText(sceneId, x300053_g_scriptId,"#c00ffff新凤鸣镇     #R【新凤鸣镇】", 9, 1502)
	...
	elseif key==404 then
		BeginEvent(sceneId)
			...
			AddNumText(sceneId, x300053_g_scriptId,"#c00ffff野外 - 凤鸣镇    #R【BOSS专区】", 9, 1502)
                        AddNumText(sceneId, x300053_g_scriptId,"#c00ffff通天塔顶          #R【BOSS专区】", 9, 1512)
                        AddNumText(sceneId, x300053_g_scriptId,"#c00ffff少室山         #R【BOSS专区】", 9, 1513)
                    if isNPC==0 then
				AddNumText(sceneId, x300053_g_scriptId,"#R返回主页", 8, 8888)
			end
		EndEvent(sceneId)
	...
	elseif key==1512 then
		...
		x300053_GoTo(sceneId,selfId,420, 100, 98)--嵩山竞技
	...
	elseif key==403 then
		BeginEvent(sceneId)
			...
			--AddNumText(sceneId, x300053_g_scriptId,"#c00ffff昆仑福地           #R【100 - 150】", 9, 470)
			--AddNumText(sceneId, x300053_g_scriptId,"#c00ffff凤凰陵墓           #R【100 - 150】", 9, 462)
			--AddNumText(sceneId, x300053_g_scriptId,"#c00ffff天劫楼7层           #R【100 - 150】", 9, 464)
...
function x300053_SuiShen(sceneId,selfId)
	...
	elseif GetNumText() == 130  then
		BeginEvent(sceneId)
			...
			ddNumText( sceneId, x300053_g_scriptId, "#c00ffff领取100级奖励     #gFF3E96[10W]赠点", 5, 132 )
...
function x300053_JiaRuMenPai(sceneId,selfId,key)
	...
	if key == 200 then
		BeginEvent( sceneId )
			...
			AddText( sceneId, "    #Y新手可直接选择门派加入，如需更换门派，请到元宝商店购买#G门派转换令#Y。" )
