...
--免疫特定技能buff....
x910008_Buff_MianYi1	= 10473	--免疫一些负面效果....
x910008_Buff_MianYi2	= 10471	--免疫普通隐身....
...
--AI Index....
x910008_IDX_StopWatch						= 1	--秒表....
x910008_IDX_SkillA_CD						= 2	--A技能的CD时间....
x910008_IDX_SkillB_HPStep				= 3	--血量级别....
x910008_IDX_SkillB_Step					= 4	--B技能的Step....0=未发动 15=buff1 14=buff2 …… 1=buff15
x910008_IDX_SkillB_Type					= 5	--当前正在使用哪种类型的剑舞....
x910008_IDX_SkillC_CD						= 6	--C技能的CD时间....
x910008_IDX_SkillD_CD						= 7	--C技能的CD时间....
x910008_IDX_KuangBaoTimer				= 8	--狂暴的计时器....


x910008_IDX_CombatFlag 			= 1	--是否处于战斗状态的标志....
x910008_IDX_IsKuangBaoMode	= 2	--是否处于狂暴模式的标志....
...
--	CallScriptFunction( x910008_g_FuBenScriptId, "SetBossBattleFlag", sceneId, "LiQiuShui", 2 )
	...
	if playerName ~= nil then
		str = format("#{_INFOUSR%s}#P在四绝庄#P中与#Y[庞企]#P大战三百回合后，#Y[庞企]#P大汗淋漓，对#{_INFOUSR%s}说：自古长江后浪推前浪，今天我庞企死在你手上！话毕，自刎于星罗坛。", playerName); --李秋水
