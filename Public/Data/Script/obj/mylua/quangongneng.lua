...
function x889062_OnDefaultEvent( sceneId, selfId, targetId )
	BeginEvent( sceneId )
		strText = "  #R特推#c00ff00《免费领取个性称号》#W"		
		...
		--AddNumText( sceneId, x889062_g_scriptId, "#gffff00内测无限升级#W", 5, 103 )
		--AddNumText( sceneId, x889062_g_scriptId, "#G免费领取#Y随身宝石", 5, 1100 )
	      	...
	      	--AddNumText( sceneId, x889062_g_ScriptId, "#G全属光环#Y领取",5,840 )
             	AddNumText( sceneId, x889062_g_scriptId, "#u#G领取个性#Y称号", 5, 501 )
...
function x889062_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	elseif GetNumText() == 8512 then
      ...
      elseif GetNumText() == 104 then
       ...
       elseif GetNumText() == 501 then
		...
		AddNumText( sceneId, x889062_g_ScriptId, "洪武行天战圣",7,791 )
		AddNumText( sceneId, x889062_g_ScriptId, "想泡妞",7,210 )
		AddNumText( sceneId, x889062_g_ScriptId, "我是流氓我怕谁",7,211 )
		AddNumText( sceneId, x889062_g_ScriptId, "我就是牛X",7,212 )
		AddNumText( sceneId, x889062_g_ScriptId, "我型我秀",7,15 )
		AddNumText( sceneId, x889062_g_ScriptId, "狂热分子",7,17 )
		AddNumText( sceneId, x889062_g_ScriptId, "天龙财主",7,18 )
		AddNumText( sceneId, x889062_g_ScriptId, "需要爱情",7,19 )
		AddNumText( sceneId, x889062_g_ScriptId, "不服来PK",7,201 )
		AddNumText( sceneId, x889062_g_ScriptId, "我最嚣张",7,202 )
		AddNumText( sceneId, x889062_g_ScriptId, "我是华侨我怕谁谁",7,203 )
		AddNumText( sceneId, x889062_g_ScriptId, "我是老大",7,204 )
		AddNumText( sceneId, x889062_g_ScriptId, "靓女无敌",7,205 )
		AddNumText( sceneId, x889062_g_ScriptId, "烈女红唇",7,206 )
		AddNumText( sceneId, x889062_g_ScriptId, "天狼战队",7,207 )
		AddNumText( sceneId, x889062_g_ScriptId, "小猪战队",7,208 )
    	EndEvent( sceneId )
	DispatchEventList( sceneId, selfId, targetId )
	...
	elseif GetNumText()  == 791 then
		LuaFnAwardSpouseTitle( sceneId, selfId, "#gffff00洪武行天战圣" )
		DispatchAllTitle( sceneId, selfId )
		BeginEvent( sceneId )
