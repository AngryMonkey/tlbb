...
function x889063_OnDefaultEvent( sceneId, selfId,targetId )
	BeginEvent(sceneId)
		...
		AddText( sceneId, "#c0066ff消耗#W：#G（#cFF0000LV1-LV2#G）#cFF0000一段熔炼精华#Y30个,#W成功几率#cFF000090#Y%!" )
		AddText( sceneId, "#c0066ff消耗#W：#G（#cFF0000LV2-LV3#G）#cFF0000二段熔炼精华#Y30个,#W成功几率#cFF000080#Y%!" )
		AddText( sceneId, "#c0066ff消耗#W：#G（#cFF0000LV3-LV4#G）#cFF0000二段熔炼精华#Y50个,#W成功几率#cFF000070#Y%!" )
		AddText( sceneId, "#c0066ff消耗#W：#G（#cFF0000LV4-LV5#G）#cFF0000三段熔炼精华#Y50个#W和#cFF0000天玑珠#Y50个,#W成功几率#cFF000060#Y%！" )
		...
		AddNumText( sceneId, x889063_g_ScriptId, "顶级神器#G进化#cFF0000终极↑", 5, 300 )
...
function x889063_OnEventRequest( sceneId, selfId, targetId, eventId)
	if GetNumText() == 100 then
		BeginEvent( sceneId )
		      ...
		      AddText( sceneId, "#c0066ff熔炼精华#W可以在#Y幻境副本#W获得!" )
		      AddText( sceneId, "#c0066ff消耗#W：#G（#cFF0000LV1-LV2#G）#cFF0000一段熔炼精华#Y30个,#W成功几率#cFF000090#Y%!" )
		      AddText( sceneId, "#c0066ff消耗#W：#G（#cFF0000LV2-LV3#G）#cFF0000二段熔炼精华#Y30个,#W成功几率#cFF000080#Y%!" )
		      AddText( sceneId, "#c0066ff消耗#W：#G（#cFF0000LV3-LV4#G）#cFF0000二段熔炼精华#Y50个,#W成功几率#cFF000070#Y%!" )
		      AddText( sceneId, "#c0066ff消耗#W：#G（#cFF0000LV4-LV5#G）#cFF0000三段熔炼精华#Y50个#W和#cFF0000天玑珠#Y50个,#W成功几率#cFF000060#Y%!" )
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=30 then
				...
				BeginEvent( sceneId ) 
					...
					LuaFnDelAvailableItem(sceneId,selfId,30503098,30)--删除物品
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=50 then
				...
				BeginEvent( sceneId ) 
					...
					LuaFnDelAvailableItem(sceneId,selfId,30503098,50)--删除物品
	...
	elseif GetNumText() == 1041 then
	       	...
	       	local nStoneId1 = 30503099
	       	local nStoneId2 = 30501173
		c0 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId0)
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
		c2 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId2)
            if c0 >=1 and c1 >=50 and c2 >=50 then
	                    local rand = random(1000)
                           if rand < 600 then
				BeginEvent( sceneId ) 
		                    local playername = GetName(sceneId, selfId)
					LuaFnDelAvailableItem(sceneId,selfId,10300011,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30503099,50)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30501173,50)--删除物品
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=1 then
				BeginEvent( sceneId ) 
					...
					LuaFnDelAvailableItem(sceneId,selfId,30503098,1)--删除物品
	...
	elseif GetNumText() == 300 then
		BeginEvent( sceneId )
		      AddText( sceneId, "#cFF0000顶级神器#W可以进化为#G终极神器#W。#Y终极神器#W拥有#cFF0000官方最新外观和状态#W，终极神器#Y拥有其他神器所没有的状态和触发!" )
		      AddText( sceneId, "神器升级为#cFF0000顶级神器#W后可以进化，进化必需品为#Y神兵进化符！#Y神兵进化符#W可以在元宝商店购买或者各大副本获得。" )
		      AddText( sceneId, "#c0066ff消耗#W：#cFF0000顶级神器#Y1把#W和#cFF0000神兵进化符#Y5#W个,#W成功几率#cFF0000100#Y%！" )
		      AddText( sceneId, "#cff99ff提示（#G请拆下已镶嵌的宝石#cff99ff）" )
			AddNumText( sceneId, x889063_g_scriptId, "#cFF0000赤焰九纹刀#Y终极进化", 5, 301)
			AddNumText( sceneId, x889063_g_scriptId, "#cFF0000斩忧断愁枪#Y终极进化", 5, 302)
			AddNumText( sceneId, x889063_g_scriptId, "#cFF0000万仞龙渊剑#Y终极进化", 5, 303)
			AddNumText( sceneId, x889063_g_scriptId, "#cFF0000转魂灭魄钩#Y终极进化", 5, 304)
			AddNumText( sceneId, x889063_g_scriptId, "#cFF0000雷鸣离火扇#Y终极进化", 5, 305)
			AddNumText( sceneId, x889063_g_scriptId, "#cFF0000碎情雾影环#Y终极进化", 5, 306)
			AddNumText( sceneId, x889063_g_scriptId, "取消", 5, 4)
		EndEvent( sceneId )
		DispatchEventList( sceneId, selfId, targetId )

	elseif GetNumText() == 301 then
	       	local nStoneId0 = 10300012
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=5 then
				BeginEvent( sceneId ) 
		                    local playername = GetName(sceneId, selfId)
					LuaFnDelAvailableItem(sceneId,selfId,10300012,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,5)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10300007, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
		                     local Text = format("@*;SrvMsg;SCA:#G[系统]:#G洛阳城金光闪耀,恭喜#{_INFOUSR%s}顶级神器进化成功,一把#{_INFOMSG%s}出现在手中!终极神器拥有官方最新外观特效哦~ ", playername, szItemTransfer)									
		                     BroadMsgByChatPipe(sceneId, selfId, Text, 4)
					strText = "#G恭喜你，神器进化成功！您获得了终极神器！"
					AddText( sceneId, strText )
				EndEvent( sceneId )
               	DispatchEventList( sceneId, selfId, targetId )
                    else
               	BeginEvent( sceneId ) 
					strText = "#Y你的材料不够，终极神器进化需要#cFF0000顶级神器#W和#cFF0000神兵进化符#Y各一个！！"
					AddText( sceneId, strText )					
				EndEvent( sceneId )
               	DispatchEventList( sceneId, selfId, targetId )
			end
	...
	elseif GetNumText() == 302 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=5 then
				BeginEvent( sceneId ) 
		                    local playername = GetName(sceneId, selfId)
					LuaFnDelAvailableItem(sceneId,selfId,10301006,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,5)--删除物品
	...
	elseif GetNumText() == 304 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=5 then
				BeginEvent( sceneId ) 
		                    local playername = GetName(sceneId, selfId)
					LuaFnDelAvailableItem(sceneId,selfId,10303006,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,5)--删除物品
	...
	elseif GetNumText() == 305 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=5 then
				BeginEvent( sceneId ) 
		                    local playername = GetName(sceneId, selfId)
					LuaFnDelAvailableItem(sceneId,selfId,10304014,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,5)--删除物品
					local bagpos01 = TryRecieveItem( sceneId, selfId, 10304009, 1)--给予物品
				       local szItemTransfer = GetBagItemTransfer( sceneId, selfId, bagpos01 )
		                     local Text = format("@*;SrvMsg;SCA:#G[系统]:#G洛阳城金光闪耀,恭喜#{_INFOUSR%s}顶级神器进化成功,一把#{_INFOMSG%s}出现在手中!终极神器拥有官方最新外观特效哦~ ", playername, szItemTransfer)									
		                     BroadMsgByChatPipe(sceneId, selfId, Text, 4)
					strText = "#G恭喜你，神器进化成功！您获得了终极神器！"
	...
	elseif GetNumText() == 306 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=5 then
				BeginEvent( sceneId ) 
		                    local playername = GetName(sceneId, selfId)
					LuaFnDelAvailableItem(sceneId,selfId,10305014,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,30505817,5)--删除物品
