...
--免疫Buff....
x402085_Buff_MianYi1	= 10472	--免疫一些负面效果....
x402085_Buff_MianYi2	= 10471	--免疫普通隐身....
...
--AI Index....
x402085_IDX_CD_SkillABC		= 1	--ABC技能的CD....
x402085_IDX_CurSkillIndex	= 2	--接下来该使用ABC中的哪个技能....
x402085_IDX_CD_SkillD			= 3	--D技能的CD....

x402085_IDX_CombatFlag 		= 1	--是否处于战斗状态的标志....
