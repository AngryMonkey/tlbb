...
--免疫特定技能buff....
x402084_Buff_MianYi1	= 10472	--免疫一些负面效果....
x402084_Buff_MianYi2	= 10471	--免疫普通隐身....

--A土遁....
x402084_SkillA_TuDun				= 1028
x402084_SkillA_ChildName		= "同心竹·紫"
x402084_SkillA_ChildBuff		= 10246
x402084_SkillA_ChildTime		= 5000		--土遁多长时间后开始刷小怪....
x402084_SkillA_Time					= 20000		--土遁持续的时间....
...
--AI Index....
x402084_IDX_HPStep							= 1	--血量级别....
x402084_IDX_SkillB_CD						= 2	--B技能的CD时间....
x402084_IDX_KuangBaoTimer				= 3	--狂暴的计时器....
x402084_IDX_TuDunTimer					= 4	--土遁的计时器....用于计算何时土遁结束....
x402084_IDX_NeedCreateChildNum	= 50	--需要创建的小怪的数量....

x402084_IDX_CombatFlag 			= 1	--是否处于战斗状态的标志....
x402084_IDX_IsTudunMode			= 2	--是否处于土遁模式的标志....
x402084_IDX_IsKuangBaoMode	= 3	--是否处于狂暴模式的标志....
