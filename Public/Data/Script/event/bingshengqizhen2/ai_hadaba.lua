...
--buff....
x402070_Buff_MianYi1	= 10473	--免疫一些负面效果....
x402070_Buff_MianYi2	= 10471	--免疫普通隐身....
x402070_Skill_A			=	751
x402070_Buff_A			= 9996
...
--AI Index....
x402070_IDX_CombatTime		= 1	--进入战斗的计时器....用于记录已经进入战斗多长时间了....
x402070_IDX_UseSkillIndex	= 2	--接下来该使用技能表中的第几个技能....

x402070_IDX_CombatFlag 			= 1	--是否处于战斗状态的标志....
x402070_IDX_IsKuangBaoMode	= 2	--是否处于狂暴模式的标志....
