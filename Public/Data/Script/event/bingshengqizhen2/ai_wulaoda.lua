...
--免疫Buff....
x402072_Buff_MianYi1	= 10472	--免疫一些负面效果....
x402072_Buff_MianYi2	= 10471	--免疫普通隐身....
...
--AI Index....
x402072_IDX_CD_SkillABC		= 1	--ABC技能的CD....
x402072_IDX_CurSkillIndex	= 2	--接下来该使用ABC中的哪个技能....
x402072_IDX_CD_SkillD			= 3	--D技能的CD....

x402072_IDX_CombatFlag 		= 1	--是否处于战斗状态的标志....
...
function x402072_OnDie( sceneId, selfId, killerId )
	...
	if playerName ~= nil then
		str = format("#{_INFOUSR%s}#P与众多队友在兵圣奇阵#P中追着#Y[萧如蔚]#P打......#Y[萧如蔚]#P被迫乖乖投降。", playerName); --乌老大
...
function x402072_UseSkillC( sceneId, selfId )
	...
	--喊话....
	MonsterTalk( sceneId, -1, "", "#ccc9933[萧如蔚]#W奇阵中自有奇妙的陷阱，接招！" )
