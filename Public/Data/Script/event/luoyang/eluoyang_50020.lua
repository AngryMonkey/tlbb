...
--任务文本描述
x250020_g_MissionName="捕捉珍兽"
x250020_g_MissionInfo="我家小姐想要一只鹦鹉。"  --任务描述
x250020_g_MissionTarget="帮云涵儿找到一只鹦鹉。"		--任务目标
x250020_g_ContinueInfo="你捉到鹦鹉了吗？"		--未完成任务的npc对话
x250020_g_MissionComplete="干的不错。"					--完成任务npc说话的话
	...
	if indexpet == 255 then --索引值返回255表示空，没提交珍兽
		...
		if petdataid == x250020_g_PetDataID then
			--奖励金钱并提示
				...
				BeginEvent(sceneId)
					AddText(sceneId,"恭喜你完成了任务，奖励你#{_MONEY"..x250020_g_MoneyBonus.."}")
				EndEvent(sceneId)
